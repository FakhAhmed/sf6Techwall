...
class __TwigTemplate_3d5f49b1d4b1f4c3d1023e3ba932ac8c extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 22
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 22, $this->source); })()), "session", [], "any", false, false, false, 22), "flashBag", [], "any", false, false, false, 22), "get", [0 => "error"], "method", false, false, false, 22));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 23
...
";
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 27
        echo "<h1>Liste des todos : </h1>
<al class=\"list-group\">
    ";
        // line 29
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 29, $this->source); })()), "session", [], "any", false, false, false, 29), "get", [0 => "todos"], "method", false, false, false, 29));
    ...
    {
        return array (  129 => 34,  118 => 31,  115 => 30,  111 => 29,  107 => 27,  98 => 24,  95 => 23,  91 => 22,  82 => 19,  79 => 18,  75 => 17,  66 => 14,  63 => 13,  59 => 12,  52 => 8,  43 => 1,);
    }
...
</html>", "todo/index.html.twig", "C:\\xampp\\htdocs\\sf6Techwall\\templates\\todo\\index.html.twig");
    }
}
